...
entity user_logic is
  ...
  (
    ...
    Bus2IP_Clk    : in  std_logic; -- CLK
    Bus2IP_Resetn : in  std_logic; -- Reset
    Bus2IP_Data   : in  std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data in
    Bus2IP_BE     : in  std_logic_vector(C_SLV_DWIDTH/8-1 downto 0); -- Data in byte enable
    Bus2IP_RdCE   : in  std_logic_vector(C_NUM_REG-1 downto 0); -- Read CE
    Bus2IP_WrCE   : in  std_logic_vector(C_NUM_REG-1 downto 0); -- Write CE
    IP2Bus_Data   : out std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data out
    IP2Bus_RdAck  : out std_logic; -- Data in ack
...
architecture IMP of user_logic is
  ...
  ------------------------------------------
  signal slv_reg0                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 15
  signal slv_reg1                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 14
  signal slv_reg2                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 13
  signal slv_reg3                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 12
  signal slv_reg4                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 11
  signal slv_reg5                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 10
  signal slv_reg6                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 9
  signal slv_reg7                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 8
  signal slv_reg8                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 7
  signal slv_reg9                       : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 6
  signal slv_reg10                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 5
  signal slv_reg11                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 4
  signal slv_reg12                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 3
  signal slv_reg13                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 2
  signal slv_reg14                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 1
  signal slv_reg15                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Data 0
  signal slv_reg16                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 7
  signal slv_reg17                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 6
  signal slv_reg18                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 5
  signal slv_reg19                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 4
  signal slv_reg20                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 3
  signal slv_reg21                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 2
  signal slv_reg22                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 1
  signal slv_reg23                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Init 0
  signal slv_reg24                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 7
  signal slv_reg25                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 6
  signal slv_reg26                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 5
  signal slv_reg27                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 4
  signal slv_reg28                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 3
  signal slv_reg29                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 2
  signal slv_reg30                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 1
  signal slv_reg31                      : std_logic_vector(C_SLV_DWIDTH-1 downto 0); -- Hash Output 0
...
begin
  ...
  --USER logic implementation added here
    ...
    port map(
      ...
      msg_in => slv_reg15 & slv_reg14 & slv_reg13 & slv_reg12 & slv_reg11 & slv_reg10 & slv_reg9 & slv_reg8 & slv_reg7 & slv_reg6 & slv_reg5 & slv_reg4 & slv_reg3 & slv_reg2 & slv_reg1 & slv_reg0,
      h_in   => slv_reg23 & slv_reg22 & slv_reg21 & slv_reg20 & slv_reg19 & slv_reg18 & slv_reg17 & slv_reg16,
      digest => digest_out
    );

  digest_out <= slv_reg31 & slv_reg30 & slv_reg29 & slv_reg28 & slv_reg27 & slv_reg26 & slv_reg25 & slv_reg24;
  ------------------------------------------
